...
trait StreamingJob {
  ...
  def enrichDevicesWithUserMetadata(devicesDF: DataFrame, userMetadataDF: DataFrame): DataFrame
    ...
    def run(args: Array[String]): Unit = {
      val Array(kafkaServer, topic, jdbcUri, jdbcMetadataTable, jdbcUser, jdbcPassword, storagePath) = args
      ...
      // ARGS: KAFKA_SERVER:9092 devices jdbc:postgresql://34.78.249.75:5432/postgres user_metadata postgres keepcoding /tmp/data-simulator/
    }
